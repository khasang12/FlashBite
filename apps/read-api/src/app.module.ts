...
import { AuthMiddleware, CorrelationMiddleware, TokenVerifier, TenantGuard } from "@flashbite/tenant-context";
...
@Module({
  ...
  providers: [
    ...
    { provide: CorrelationMiddleware, useFactory: () => new CorrelationMiddleware(createLogger("read-api")) },
  ],
})
